...
#error TRC_HARDWARE_PORT_HWIndependent is deprecated
	...
	**************************************************************************/
		...
		extern uint32_t cortex_a9_r5_enter_critical(uint32_t* pulSavedInterruptStatus);
		extern void cortex_a9_r5_exit_critical(uint32_t irq_already_masked_at_enter, uint32_t ulSavedInterruptStatus);

		#define TRACE_ALLOC_CRITICAL_SECTION()														\
			TraceUnsignedBaseType_t TRACE_ALLOC_CRITICAL_SECTION_NAME;								\
			TraceUnsignedBaseType_t uxSavedInterruptStatus;											
		#define TRACE_ENTER_CRITICAL_SECTION() { TRACE_ALLOC_CRITICAL_SECTION_NAME = (TraceUnsignedBaseType_t)cortex_a9_r5_enter_critical((uint32_t*) &uxSavedInterruptStatus); }
		#define TRACE_EXIT_CRITICAL_SECTION() { cortex_a9_r5_exit_critical((uint32_t)TRACE_ALLOC_CRITICAL_SECTION_NAME, (uint32_t) uxSavedInterruptStatus); }
	...
	#define TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS	0xF8F00000
		...
		#define TRC_CA9_GT_COUNTER_REGISTER_LOW32_OFFSET     	0x0

		/* Global timer registers addresses */
		#define TRC_CA9_GT_BASE_ADDRESS                        	(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + 0x0200)
		#define TRC_CA9_GT_COUNTER_REGISTER_LOW32_ADDRESS       (TRC_CA9_GT_BASE_ADDRESS + TRC_CA9_GT_COUNTER_REGISTER_LOW32_OFFSET)

		/* Global timer registers */
		#define TRC_CA9_GT_COUNTER_REGISTER_LOW32               (*((volatile uint32_t *) TRC_CA9_GT_COUNTER_REGISTER_LOW32_ADDRESS))

		#define TRC_HWTC_TYPE                           TRC_FREE_RUNNING_32BIT_INCR
		#define TRC_HWTC_COUNT                          TRC_CA9_GT_COUNTER_REGISTER_LOW32
		#define TRC_HWTC_PERIOD                         0
		#define TRC_HWTC_DIVISOR 						1		
		#define TRC_HWTC_FREQ_HZ 						TRACE_CPU_CLOCK_HZ

	#else /* ( TRC_CFG_CORE_COUNT > 1 ) */
